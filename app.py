...
<p style="font-family:'Space Mono',monospace;font-size:10px;color:#00c853;margin:0;letter-spacing:3px">SECURITY & PRIVACY RISK ASSESSMENT TOOL</p>
</div></div></div>
""", unsafe_allow_html=True)
...
if st.session_state['page'] == 'home':
    ...
    with c1:
        st.markdown("""<div style="background:#0e2028;border:1px solid rgba(255,77,109,0.3);border-radius:16px;padding:32px 24px;text-align:center;margin-bottom:16px;min-height:260px">
...
<text x="36" y="27" font-size="10" font-weight="800" fill="#00c853" text-anchor="middle" font-family="Space Mono,monospace">C</text>
    ...
    with c2:
        st.markdown("""<div style="background:#0e2028;border:1px solid rgba(0,200,83,0.3);border-radius:16px;padding:32px 24px;text-align:center;margin-bottom:16px;min-height:260px">
        <div style="margin-bottom:16px"><svg width="52" height="52" viewBox="0 0 52 52" xmlns="http://www.w3.org/2000/svg">
...
<path d="M34 14 L38 18 L46 10" fill="none" stroke="#00c853" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    with c3:
        st.markdown("""<div style="background:#0e2028;border:1px solid rgba(247,37,133,0.3);border-radius:16px;padding:32px 24px;text-align:center;margin-bottom:16px;min-height:260px">
        <div style="margin-bottom:16px"><svg width="52" height="52" viewBox="0 0 52 52" xmlns="http://www.w3.org/2000/svg">
...
#  SECURITY SCAN 
    ...
    for i, (icon, name, desc, sev, color) in enumerate(attacks):
        with cols_attacks[i]:
            st.markdown(f"""<div style="background:#0e2028;border:1px solid rgba(0,200,83,0.12);border-radius:12px;padding:14px 12px;text-align:center;min-height:160px">
