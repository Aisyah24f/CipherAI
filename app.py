...
if st.session_state['page'] == 'home':
    ...
    with c1:
        st.markdown("""<div style="background:#0e2028;border:1px solid rgba(255,77,109,0.3);border-radius:16px;padding:32px 24px;text-align:center;margin-bottom:16px;height:260px">
